(function ($) {
	...
	$("#slider-range").slider({
        ...
        min: 0,
        max: 1000000,
        step: 100, // Set the step to 100, so the slider increases with increments of 100
        values: [0, 1000000],
        slide: function (event, ui) {
            var minValue = Math.floor(ui.values[0] / 100) * 100; // Round down to the nearest multiple of 100
            var maxValue = Math.ceil(ui.values[1] / 100) * 100;  // Round up to the nearest multiple of 100
            $("#amount").val("DA" + minValue + " - DA" + maxValue);
        }
    });
