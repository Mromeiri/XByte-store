            ...
            <div class="row">
                <div class="col-12 text-center">
                    <div class="breadcrumb-content position-relative section-content">
                        <h3 class="title-3">Vérification</h3>
                        <ul>
                ...
                <div class="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-custom">
                    <div class="login-register-wrapper">
                        <div class="section-content text-center mb-5">
                            <h2 class="title-4 mb-2">Vérify your email</h2>
                        </div>
                        <form action="sign/SOSverification.php" method="post">
                            <div class="single-input-item mb-3">
                                <input type="number" placeholder="Code of 6 Numbers" name="code" required>
                            </div>
                            <div class="single-input-item mb-3">
                                <button class="btn flosun-button secondary-btn theme-color rounded-0">Verify</button>
                            </div>
                        </form>
                    </div>
                </div>
